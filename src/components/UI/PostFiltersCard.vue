        ...
        <router-link :to="{ name: 'hot' }">
          ...
          >
            ...
            <img
                ...
                class="h-5 pr-2"
            />
            <p :class="route.name === 'hot' ? 'text-[#0079d3] dark:text-[#ff6542]' : 'text-zinc-900 dark:text-zinc-300' ">Hot</p>
          </div>
        </router-link>
        ...
        <router-link :to="{ name: 'new' }">
          ...
          >
            ...
            <img
                ...
                class="h-5 pr-2"
            />
            <p :class="route.name === 'new' ? 'text-[#0079d3] dark:text-[#ff6542]' : 'text-zinc-900 dark:text-zinc-300' ">New</p>
          </div>
        </router-link>
      </div>
    </div>
