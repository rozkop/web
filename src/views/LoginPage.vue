          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form @submit.prevent="logIn" class="space-y-4 md:space-y-6">
              <div>
                ...
                <input v-model="user.email" type="email" name="email" id="email" class="autofill:!bg-transparent bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-[#272729] dark:border-[#343536] dark:placeholder-gray-400 dark:text-zinc-100 outline-0" placeholder="your@email.com" required>
              </div>
              <div>
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                <input v-model="user.password" type="password" name="password" id="password" placeholder="••••••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-[#272729] dark:border-[#343536] dark:placeholder-gray-400 dark:text-white outline-0" required minlength="8">
              </div>
